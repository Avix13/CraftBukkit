	...
	public static void l() {
		...
		while (iterator.hasNext()) {
			...
			if (hashset.contains(block)) {
				switch (block) {
					case Blocks.WOOL: 
						object = (new ItemCloth(Blocks.WOOL)).b("cloth"); break;
					case Blocks.STAINED_HARDENED_CLAY: 
						object = (new ItemCloth(Blocks.STAINED_HARDENED_CLAY)).b("clayHardenedStained"); break;
					case Blocks.STAINED_GLASS: 
						object = (new ItemCloth(Blocks.STAINED_GLASS)).b("stainedGlass"); break;
					case Blocks.STAINED_GLASS_PANE: 
						object = (new ItemCloth(Blocks.STAINED_GLASS_PANE)).b("stainedGlassPane"); break;
					case Blocks.WOOL_CARPET: 
						object = (new ItemCloth(Blocks.WOOL_CARPET)).b("woolCarpet"); break;
					case Blocks.DIRT: 
						object = (new ItemMultiTexture(Blocks.DIRT, Blocks.DIRT, BlockDirt.a)).b("dirt"); break;
					case Blocks.SAND: 
						object = (new ItemMultiTexture(Blocks.SAND, Blocks.SAND, BlockSand.a)).b("sand"); break;
					case Blocks.LOG: 
						object = (new ItemMultiTexture(Blocks.LOG, Blocks.LOG, BlockLog1.M)).b("log"); break;
					case Blocks.LOG2: 
						object = (new ItemMultiTexture(Blocks.LOG2, Blocks.LOG2, BlockLog2.M)).b("log"); break;
					case Blocks.WOOD: 
						object = (new ItemMultiTexture(Blocks.WOOD, Blocks.WOOD, BlockWood.a)).b("wood"); break;
					case Blocks.MONSTER_EGGS:
						object = (new ItemMultiTexture(Blocks.MONSTER_EGGS, Blocks.MONSTER_EGGS, BlockMonsterEggs.a)).b("monsterStoneEgg"); break;
					case Blocks.SMOOTH_BRICK:
						object = (new ItemMultiTexture(Blocks.SMOOTH_BRICK, Blocks.SMOOTH_BRICK, BlockSmoothBrick.a)).b("stonebricksmooth"); break;
					case Blocks.SANDSTONE:
						object = (new ItemMultiTexture(Blocks.SANDSTONE, Blocks.SANDSTONE, BlockSandStone.a)).b("sandStone"); break;
					case Blocks.QUARTZ_BLOCK:
						object = (new ItemMultiTexture(Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, BlockQuartz.a)).b("quartzBlock"); break;
					case Blocks.STEP:
						object = (new ItemStep(Blocks.STEP, Blocks.STEP, Blocks.DOUBLE_STEP, false)).b("stoneSlab"); break;
					case Blocks.DOUBLE_STEP:
						object = (new ItemStep(Blocks.DOUBLE_STEP, Blocks.STEP, Blocks.DOUBLE_STEP, true)).b("stoneSlab"); break;
					case Blocks.WOOD_STEP:
						object = (new ItemStep(Blocks.WOOD_STEP, Blocks.WOOD_STEP, Blocks.WOOD_DOUBLE_STEP, false)).b("woodSlab"); break;
					case Blocks.WOOD_DOUBLE_STEP:
						object = (new ItemStep(Blocks.WOOD_DOUBLE_STEP, Blocks.WOOD_STEP, Blocks.WOOD_DOUBLE_STEP, true)).b("woodSlab"); break;
					case Blocks.SAPLING:
						object = (new ItemMultiTexture(Blocks.SAPLING, Blocks.SAPLING, BlockSapling.a)).b("sapling"); break;
					case Blocks.LEAVES:
						object = (new ItemLeaves(Blocks.LEAVES)).b("leaves"); break;
					case Blocks.LEAVES2:
						object = (new ItemLeaves(Blocks.LEAVES2)).b("leaves"); break;
					case Blocks.VINE:
						object = new ItemWithAuxData(Blocks.VINE, false); break;
					case Blocks.LONG_GRASS:
						object = (new ItemWithAuxData(Blocks.LONG_GRASS, true)).a(new String[] { "shrub", "grass", "fern"}); break;
					case Blocks.YELLOW_FLOWER:
						object = (new ItemMultiTexture(Blocks.YELLOW_FLOWER, Blocks.YELLOW_FLOWER, BlockFlowers.b)).b("flower"); break;
					case Blocks.RED_ROSE:
						object = (new ItemMultiTexture(Blocks.RED_ROSE, Blocks.RED_ROSE, BlockFlowers.a)).b("rose"); break;
					case Blocks.SNOW:
						object = new ItemSnow(Blocks.SNOW, Blocks.SNOW); break;
					case Blocks.WATER_LILY:
						object = new ItemWaterLily(Blocks.WATER_LILY); break;
					case Blocks.PISTON:
						object = new ItemPiston(Blocks.PISTON); break;
					case Blocks.PISTON_STICKY:
						object = new ItemPiston(Blocks.PISTON_STICKY); break;
					case Blocks.COBBLE_WALL:
						object = (new ItemMultiTexture(Blocks.COBBLE_WALL, Blocks.COBBLE_WALL, BlockCobbleWall.a)).b("cobbleWall"); break;
					case Blocks.ANVIL:
						object = (new ItemAnvil(Blocks.ANVIL)).b("anvil"); break;
					case Blocks.DOUBLE_PLANT:
						object = (new ItemTallPlant(Blocks.DOUBLE_PLANT, Blocks.DOUBLE_PLANT, BlockTallPlant.a)).b("doublePlant"); break;
						// CraftBukkit start - allow certain blocks to retain data
					case Blocks.MOB_SPAWNER || block == Blocks.BIG_MUSHROOM_1 || block == Blocks.BIG_MUSHROOM_2:
						object = new ItemWithAuxData(block, true); break;
						// CraftBukkit end
				}
			} else {
